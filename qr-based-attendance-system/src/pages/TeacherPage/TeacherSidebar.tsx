...
import { Calendar, Bell, User, LogOut, DoorClosedIcon } from "lucide-react"; // Importing Lucide icons
...
const TeacherSidebar: React.FC<SidebarProps> = ({ isSidebarCollapsed }) => {
    ...
    >
      {!isSidebarCollapsed && (
        <ul className="space-y-4">
          ...
          <li className="border-b border-white">
            <a
              onClick={() => navigate("/teacher-dashboard/calendar")}
              className="flex items-center gap-2 p-2 rounded hover:bg-gray-700 text-white cursor-pointer"
            >
